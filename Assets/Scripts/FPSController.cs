...
public class FPSController : MonoBehaviour
{
    ...
    public float forwardBackwardSpeed= 0f;
    ...
    void Update()
    {
        ...
        float curSpeedX = canMove ? (isRunning ? runningSpeed : walkingSpeed) * (Input.GetAxis("Vertical") !=0 ? Input.GetAxis("Vertical") : forwardBackwardSpeed) : 0;
    ...
    public void RotationMotion(float value)
    {
        rotationSpeed = value;
    }
}
